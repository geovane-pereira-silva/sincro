...
const NAV = [
  ...
  { to: "/admin/exportar", label: "Exportar", icon: Download, exact: false },
  { to: "/admin/financeiro", label: "Financeiro", icon: DollarSign, exact: false },
  { to: "/admin/webhook", label: "Webhook", icon: Webhook, exact: false },
  { to: "/admin/registros", label: "Registros", icon: Clock, exact: false },
  { to: "/admin/auditoria", label: "Auditoria", icon: History, exact: false },
